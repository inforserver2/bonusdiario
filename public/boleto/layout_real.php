...
<meta name="Generator" content="Projeto BoletoPHP - www.boletophp.com.br - Licena GPL" />
<style type=text/css>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><table width=666 cellspacing=5 cellpadding=0 border=0>
      <tr>
        <td width=41></TD>
      </tr>
    </table>
      <table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
        <tr>
          <td width=41><IMG SRC="/boleto/imagens/logo.gif"></td>
          <td class=tiX>&nbsp;</td>
          <td align=RIGHT width=500 class=ti1><span class="tiX"><?php echo $dadosboleto["identificacao"]; ?> <br />
              <?php echo $bill["description"]; ?><br />
para <?php echo $contact["complete_name"]; ?><br />
<?php // echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?>
      ...
      <table cellspacing=0 cellpadding=0 width=666 border=0>
        ...
        <tbody>
          <tr>
            <td class=ct width=666><div align=right></div></td>
          </tr>
          <tr>
            <td class=ct width=666><img height=1 src=imagens/6.png width=665 border=0></td>
          </tr>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
        ...
        <TBODY>
          <TR>
            <TD class=ct width=666><div align=right><br>
              <br>
            </div></TD>
          </TR>
          <TR>
