...
.ti1 {font: 9px Arial, Helvetica, sans-serif}
.tiX {	font-family: Arial, Helvetica, sans-serif;
	font-size: 14px;
	font-weight: bold;
}
-->
...
<div id="container">
	...
	<div id="instr_header">
      ...
      <table width="666" cellspacing="5" cellpadding="0" border="0">
        <tr>
          <td><img src="/boleto/imagens/logo.gif" /></td>
          <td class="tiX">&nbsp;</td>
          <td align="right" class="ti1"><span class="tiX"><?php echo $dadosboleto["identificacao"]; ?> <br />
